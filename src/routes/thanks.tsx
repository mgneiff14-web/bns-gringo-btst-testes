        ...
        <div className="tp-shell">
          ...
          <section className="tp-card" aria-labelledby="thanks-title">
            ...
            <div className="tp-button-row">
              <a className="tp-primary" href="https://northstarcashdigital.life/tasks-app" aria-label="Go to Task Partners dashboard">
                Go to Dashboard
            ...
            <section className="tp-support" aria-labelledby="support-title">
              ...
              <a className="tp-email" href="mailto:support@northstarcashdigital.life">support@northstarcashdigital.life</a>
            </section>
          ...
          <footer className="tp-footer" aria-label="Footer links">
            <a href="https://northstarcashdigital.life/privacy">Privacy Policy</a>
            <a href="https://northstarcashdigital.life/terms">Terms of Service</a>
            <a href="https://northstarcashdigital.life/refund">Refund Policy</a>
            <a href="https://northstarcashdigital.life/contact">Contact</a>
          </footer>
        </div>
      </main>
    </>
