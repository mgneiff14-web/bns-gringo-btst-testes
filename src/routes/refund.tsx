  ...
  return (
    <LegalLayout label="Policy" title="Refund Policy">
      ...
      <Section title="How To Request A Refund">
        <p>Email <a className="font-bold text-[#2563EB]" href="mailto:support@northstarcashdigital.life">support@northstarcashdigital.life</a> with the subject line "Refund Request" and include your purchase email.</p>
      </Section>
    </LegalLayout>
  );
}
