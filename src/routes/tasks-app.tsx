      ...
      <section className="rounded-[8px] border border-slate-200 bg-white p-4 shadow-sm">
        ...
        {chatStatus === "idle" ? (
          ...
          <>
            ...
            <a className="mt-3 block text-center text-xs font-black text-[#2563EB] underline underline-offset-2" href="mailto:support@northstarcashdigital.life?subject=Human%20support%20request">
