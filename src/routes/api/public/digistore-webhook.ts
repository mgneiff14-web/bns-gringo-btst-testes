...
const FROM = "Task Partners Support <support@northstarcashdigital.life>";
const DASHBOARD_URL = "https://northstarcashdigital.life/tasks-app?utm_source=digistore";
...
async function sendAccessEmail(email: string, firstName: string): Promise<boolean> {
  ...
  const html = emailShell({
    ...
    body: `
      ...
      <p style="margin:0 0 16px;font-size:16px;line-height:1.6;"><a href="https://northstarcashdigital.life" style="color:#FE2C55;text-decoration:underline;font-weight:700;">https://northstarcashdigital.life</a></p>
